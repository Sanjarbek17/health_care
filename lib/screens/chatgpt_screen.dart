...
class _ChatState extends State<Chat> {
  final openAI = OpenAI.instance.build(token: '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', baseOption: HttpSetup(receiveTimeout: const Duration(seconds: 5)), enableLog: true);
